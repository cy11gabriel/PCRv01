...
#UPDATE FOTO
               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        elif text.lower() == "link penting":
                          if wait["selfbot"] == True:
                               cl.sendMessage(msg.to, "[Link Penting PCR]\nDiscord: https://discord.gg/kP8dBV6\nYoutube: https://www.youtube.com/channel/UCK5EqAYB8lrVu7rso7U1JYw\nSmule: https://www.smule.com/Pitchorus")

                        elif text.lower() == "botkey":
                          if wait["selfbot"] == True:
